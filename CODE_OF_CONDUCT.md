...
community leaders responsible for enforcement by **opening an issue on this repository**. If
the report involves private information — someone else's or your own — use **GitHub Security
Advisories** (Security → Report a vulnerability) instead: it is the only private channel this
project has, and it is read by the same maintainers.
